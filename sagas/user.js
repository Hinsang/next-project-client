...
function logInAPI(data) {
  // const { me } = useSelector((state) => state.user);
  // if (me) { console.log(me); }
  return axios.post('https://next-project-server.herokuapp.com/api/Login', data);
}
...
function logOutAPI() {
  return axios.post('https://next-project-server.herokuapp.com/api/Logout');
}
...
function signUpAPI(data) {
  return axios.post('https://next-project-server.herokuapp.com/api/Signup', data);
}
