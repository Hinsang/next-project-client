...
function loadUserAPI() {
  ...
  return axios.get('http://localhost:3065/api');
...
function logInAPI(data) {
  // const { me } = useSelector((state) => state.user);
  // if (me) { console.log(me); }
  return axios.post('http://localhost:3065/api/Login', data);
}
...
function logOutAPI() {
  return axios.post('http://localhost:3065/api/Logout');
}
...
function signUpAPI(data) {
  return axios.post('http://localhost:3065/api/Signup', data);
}
